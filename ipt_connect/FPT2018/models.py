...
class Participant(models.Model):
	...
	photo = models.ImageField(upload_to=UploadToPathAndRename('FPT2018/id_photo'),help_text="Merci d'utiliser une photo d'identité.", null=True)
...
class Team(models.Model):
	...
	IOC = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True,related_name='Team_FPT2018',verbose_name="Référent")
